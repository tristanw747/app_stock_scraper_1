...
import { sharedFinalStocksNoFormat } from './public/main.js';
import { getNewsData, arrStockStatsGoogle1, arrStockStatsGoogle2 } from './public/0-stockStatsGoogle.js';
...
app.get("/StockStatsGoogle", async (req, res) => {
  for (let i = 0; i < sharedFinalStocksNoFormat.length; i++) {
    await getNewsData(sharedFinalStocksNoFormat[i]);
  }
  res.send({ product1: arrStockStatsGoogle1, product2: arrStockStatsGoogle2 });
});
